...
out_E1OS = read_Xilinx_results('../source/GNSS_signal/sim/results/E1OS_top_output_8MHz.txt',8,'signed');
E1OS = GNSSsignalgen(1,'E1OS',8*1.023e6,2); % https://github.com/danipascual/GNSS-matlab

% out_E1OS = read_Xilinx_results('../source/GNSS_signal/sim/results/E1OS_top_output_10MHz.txt',8,'signed');
% E1OS = GNSSsignalgen(1,'E1OS',10*1.023e6,2); % https://github.com/danipascual/GNSS-matlab

% out_E1OS = read_Xilinx_results('../source/GNSS_signal/sim/results/E1OS_top_output_12MHz.txt',8,'signed');
% E1OS = GNSSsignalgen(1,'E1OS',12*1.023e6,2); % https://github.com/danipascual/GNSS-matlab

% out_E1OS = read_Xilinx_results('../source/GNSS_signal/sim/results/E1OS_top_output_20MHz.txt',8,'signed');
% E1OS = GNSSsignalgen(1,'E1OS',20*1.023e6,2); % https://github.com/danipascual/GNSS-matlab

% out_E1OS = read_Xilinx_results('../source/GNSS_signal/sim/results/E1OS_top_output_50MHz.txt',8,'signed');
